...
@Getter
@Setter
@ApiModel(description = "自定义流水线关系表")
@TableName("devops_custom_pipeline_relation")
public class CustomPipelineRelationEntity extends CommonEntity implements Serializable{
    ...
    @ApiModelProperty(notes = "应用服务id", example = "应用服务id", position = 2)
