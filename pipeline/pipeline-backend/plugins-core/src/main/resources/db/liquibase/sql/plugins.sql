...
-- ----------------------------
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('b6b5010845ee41d4863931c9e71237g5', 'f6b5010845ee41d4863931c9e71237fq', '代码打包', 'build', 1, '{\r\n	\"image\": \"python:3.9\",\r\n	\"stage\": \"build\",\r\n	\"script\": [\"pip install --upgrade pip  -i https://pypi.tuna.tsinghua.edu.cn/simple/\", \"pip install pyinstaller -i https://pypi.tuna.tsinghua.edu.cn/simple/\", \"pip install -r requirements.txt -i https://pypi.tuna.tsinghua.edu.cn/simple/\", \"pyinstaller -F app.py\"],\r\n	\"artifacts\": {\r\n		\"paths\": [\"dist/app\"]\r\n	},\r\n	\"cache\": {\r\n		\"paths\": [\".cache/pip\"]\r\n	}\r\n}', 'admin', '2022-12-13 14:42:44', 'admin', '2022-12-13 14:42:49', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('b6b5010845ee41d4863931c9e71237g6', 'f6b5010845ee41d4863931c9e71237fq', '镜像制作', 'docker', 2, '{\r\n	\"image\": \"gitlabcis/docker:19.03.13\",\r\n	\"script\": [\"docker login -u ${REPOSITORY_USERNAME} -p ${REPOSITORY_PASSWORD} ${REPOSITORY_URL}\", \"docker build -t  ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION} .\", \"docker push ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\"],\r\n	\"stage\": \"docker\"\r\n}', 'admin', '2022-12-13 14:39:23', 'admin', '2022-12-13 14:39:28', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41a4863931c9e71237f3', 'f6b5010845ee41d4863931c9e71237fb', '版本生成', 'version', 3, '{\r\n	\"image\": \"curlimages/curl:latest\",\r\n	\"script\": [\"export IMAGE=${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\", \"http_status_code=`curl -o /dev/null -s -m 10 --connect-timeout 10 -w %{http_code} \\\"${GATEWAY}/hook/ci?gitlabProjectId=${CI_PROJECT_ID}&version=${DEVOPS_VERSION}&commit=${CI_COMMIT_SHA}&branch=${CI_COMMIT_REF_SLUG}&module=${SUB_SERVICE}&image=${IMAGE}\\\"`\\n      if [ \\\"$http_status_code\\\" != \\\"200\\\" ]; then\\n      echo $http_status_code\\n      echo \\\"上传应用服务版本失败\\\"\\n      exit 1\\n      fi\"],\r\n	\"stage\": \"version\"\r\n}', NULL, '2022-07-01 10:40:13', NULL, '2022-07-01 10:40:17', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41b4863931c9e71237f3', 'ed4e55889afd40d08521ebd6b2193ca8', '版本生成', 'version', 5, '{\r\n	\"image\": \"curlimages/curl:latest\",\r\n	\"script\": [\"export IMAGE=${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\", \"http_status_code=`curl -o /dev/null -s -m 10 --connect-timeout 10 -w %{http_code} \\\"${GATEWAY}/hook/ci?gitlabProjectId=${CI_PROJECT_ID}&version=${DEVOPS_VERSION}&commit=${CI_COMMIT_SHA}&branch=${CI_COMMIT_REF_SLUG}&module=${SUB_SERVICE}&image=${IMAGE}\\\"`\\n      if [ \\\"$http_status_code\\\" != \\\"200\\\" ]; then\\n      echo $http_status_code\\n      echo \\\"上传应用服务版本失败\\\"\\n      exit 1\\n      fi\"],\r\n	\"stage\": \"version\"\r\n}', NULL, '2022-07-01 10:40:13', NULL, '2022-07-01 10:40:17', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41c4863931c9e71237f3', 'f6b5010845ee41d4863931c9e71237fc', '版本生成', 'version', 5, '{\r\n	\"image\": \"curlimages/curl:latest\",\r\n	\"script\": [\"export IMAGE=${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\", \"http_status_code=`curl -o /dev/null -s -m 10 --connect-timeout 10 -w %{http_code} \\\"${GATEWAY}/hook/ci?gitlabProjectId=${CI_PROJECT_ID}&version=${DEVOPS_VERSION}&commit=${CI_COMMIT_SHA}&branch=${CI_COMMIT_REF_SLUG}&module=${SUB_SERVICE}&image=${IMAGE}\\\"`\\n      if [ \\\"$http_status_code\\\" != \\\"200\\\" ]; then\\n      echo $http_status_code\\n      echo \\\"上传应用服务版本失败\\\"\\n      exit 1\\n      fi\"],\r\n	\"stage\": \"version\"\r\n}', NULL, '2022-07-01 10:40:13', NULL, '2022-07-01 10:40:17', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41d4863931c9e71237f2', 'f6b5010845ee41d4863931c9e71237fb', '代码打包', 'build', 1, '{\r\n	\"artifacts\": {\r\n		\"paths\": [\"target/*.jar\"]\r\n	},\r\n	\"image\": \"maven:3.6.3-openjdk-8\",\r\n	\"script\": [\"mvn clean -U package -DskipTests=true\"],\r\n	\"stage\": \"build\"\r\n}', 'admin', '2022-08-16 15:39:45', 'admin', '2022-08-16 15:39:51', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41d4863931c9e71237f3', 'f6b5010845ee41d4863931c9e71237fb', '镜像制作', 'docker', 3, '{\r\n	\"image\": \"gitlabcis/docker:19.03.13\",\r\n	\"script\": [\"cp target/*.jar app.jar\", \"docker login -u ${REPOSITORY_USERNAME} -p ${REPOSITORY_PASSWORD} ${REPOSITORY_URL}\", \"docker build -t  ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION} .\", \"docker push ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\", \"export IMAGE=${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\"],\r\n	\"stage\": \"docker\"\r\n}', 'admin', '2022-08-16 15:40:24', 'admin', '2022-08-16 15:40:28', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41d4863931c9e71237f5', 'ed4e55889afd40d08521ebd6b2193ca8', '代码打包', 'build', 1, '{\r\n	\"artifacts\": {\r\n		\"paths\": [\"dist\"]\r\n	},\r\n	\"cache\": {\r\n		\"paths\": [\"node_modules\"]\r\n	},\r\n	\"image\": \"node:16.14.2\",\r\n	\"script\": [\"yarn config set registry https://registry.npm.taobao.org\", \"yarn config set disturl https://npm.taobao.org/dist\", \"yarn config set electron_mirror https://npm.taobao.org/mirrors/electron/\", \"yarn install\", \"yarn run build\"],\r\n	\"stage\": \"build\"\r\n}', 'admin', '2022-08-16 15:56:10', 'admin', '2022-08-16 15:56:17', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41d4863931c9e71237f6', 'ed4e55889afd40d08521ebd6b2193ca8', '镜像制作', 'docker', 3, '{\r\n	\"image\": \"gitlabcis/docker:19.03.13\",\r\n	\"script\": [\"docker login -u ${REPOSITORY_USERNAME} -p ${REPOSITORY_PASSWORD} ${REPOSITORY_URL}\", \"docker build -t  ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION} .\", \"docker push ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\"],\r\n	\"stage\": \"docker\"\r\n}', 'admin', '2022-08-16 15:56:51', 'admin', '2022-08-16 15:56:56', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41d4863931c9e71237f8', 'f6b5010845ee41d4863931c9e71237fc', '代码打包', 'build', 1, '{\r\n	\"artifacts\": {\r\n		\"paths\": [\"${package_path}/target/${jar_name}.jar\"]\r\n	},\r\n	\"image\": \"maven:3.6.3-openjdk-8\",\r\n	\"script\": [\"mvn clean -U package -pl ${package_path} -am -DskipTests=true\"],\r\n	\"stage\": \"build\"\r\n}', 'admin', '2022-08-24 08:37:17', 'admin', '2022-08-24 08:37:23', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41d4863931c9e71237f9', 'f6b5010845ee41d4863931c9e71237fc', '镜像制作', 'docker', 3, '{\r\n	\"image\": \"gitlabcis/docker:19.03.13\",\r\n	\"script\": [\"docker login -u ${REPOSITORY_USERNAME} -p ${REPOSITORY_PASSWORD} ${REPOSITORY_URL}\", \"docker build -t  ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION} .\", \"docker push ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\"],\r\n	\"stage\": \"docker\"\r\n}', 'admin', '2022-08-24 08:39:05', 'admin', '2022-08-24 08:39:11', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41d4863931c9e71237g5', 'f6b5010845ee41d4863931c9e71237fd', '代码打包', 'build', 1, '{\r\n	\"artifacts\": {\r\n		\"paths\": [\"app.war\"]\r\n	},\r\n	\"image\": \"lukaszimmermann/apache-ant:8-1.9.6\",\r\n	\"script\": [\"ant\"],\r\n	\"stage\": \"build\"\r\n}', 'admin', '2022-09-01 15:39:45', 'admin', '2022-09-01 15:39:51', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41d4863931c9e71237g6', 'f6b5010845ee41d4863931c9e71237fd', '镜像制作', 'docker', 3, '{\r\n	\"image\": \"gitlabcis/docker:19.03.13\",\r\n	\"script\": [\"docker login -u ${REPOSITORY_USERNAME} -p ${REPOSITORY_PASSWORD} ${REPOSITORY_URL}\", \"docker build -t  ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION} .\", \"docker push ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\"],\r\n	\"stage\": \"docker\"\r\n}', 'admin', '2022-09-01 15:40:24', 'admin', '2022-09-01 15:40:28', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41e4863931c9e71237f3', 'f6b5010845ee41d4863931c9e71237fd', '版本生成', 'version', 5, '{\r\n	\"image\": \"curlimages/curl:latest\",\r\n	\"script\": [\"export IMAGE=${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\", \"http_status_code=`curl -o /dev/null -s -m 10 --connect-timeout 10 -w %{http_code} \\\"${GATEWAY}/hook/ci?gitlabProjectId=${CI_PROJECT_ID}&version=${DEVOPS_VERSION}&commit=${CI_COMMIT_SHA}&branch=${CI_COMMIT_REF_SLUG}&module=${SUB_SERVICE}&image=${IMAGE}\\\"`\\n      if [ \\\"$http_status_code\\\" != \\\"200\\\" ]; then\\n      echo $http_status_code\\n      echo \\\"上传应用服务版本失败\\\"\\n      exit 1\\n      fi\"],\r\n	\"stage\": \"version\"\r\n}', NULL, '2022-07-01 10:40:13', NULL, '2022-07-01 10:40:17', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41f4863931c9e71237f3', 'f6b5010845ee41d4863931c9e71237fg', '版本生成', 'version', 5, '{\r\n	\"image\": \"curlimages/curl:latest\",\r\n	\"script\": [\"export IMAGE=${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\", \"http_status_code=`curl -o /dev/null -s -m 10 --connect-timeout 10 -w %{http_code} \\\"${GATEWAY}/hook/ci?gitlabProjectId=${CI_PROJECT_ID}&version=${DEVOPS_VERSION}&commit=${CI_COMMIT_SHA}&branch=${CI_COMMIT_REF_SLUG}&module=${SUB_SERVICE}&image=${IMAGE}\\\"`\\n      if [ \\\"$http_status_code\\\" != \\\"200\\\" ]; then\\n      echo $http_status_code\\n      echo \\\"上传应用服务版本失败\\\"\\n      exit 1\\n      fi\"],\r\n	\"stage\": \"version\"\r\n}', NULL, '2022-07-01 10:40:13', NULL, '2022-07-01 10:40:17', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41g4863931c9e71237f3', 'f6b5010845ee41d4863931c9e71237fi', '版本生成', 'version', 5, '{\r\n	\"image\": \"curlimages/curl:latest\",\r\n	\"script\": [\"export IMAGE=${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\", \"http_status_code=`curl -o /dev/null -s -m 10 --connect-timeout 10 -w %{http_code} \\\"${GATEWAY}/hook/ci?gitlabProjectId=${CI_PROJECT_ID}&version=${DEVOPS_VERSION}&commit=${CI_COMMIT_SHA}&branch=${CI_COMMIT_REF_SLUG}&module=${SUB_SERVICE}&image=${IMAGE}\\\"`\\n      if [ \\\"$http_status_code\\\" != \\\"200\\\" ]; then\\n      echo $http_status_code\\n      echo \\\"上传应用服务版本失败\\\"\\n      exit 1\\n      fi\"],\r\n	\"stage\": \"version\"\r\n}', NULL, '2022-07-01 10:40:13', NULL, '2022-07-01 10:40:17', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('f6b5010845ee41h4863931c9e71237f3', 'f6b5010845ee41d4863931c9e71237fq', '版本生成', 'version', 5, '{\r\n	\"image\": \"curlimages/curl:latest\",\r\n	\"script\": [\"export IMAGE=${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\", \"http_status_code=`curl -o /dev/null -s -m 10 --connect-timeout 10 -w %{http_code} \\\"${GATEWAY}/hook/ci?gitlabProjectId=${CI_PROJECT_ID}&version=${DEVOPS_VERSION}&commit=${CI_COMMIT_SHA}&branch=${CI_COMMIT_REF_SLUG}&module=${SUB_SERVICE}&image=${IMAGE}\\\"`\\n      if [ \\\"$http_status_code\\\" != \\\"200\\\" ]; then\\n      echo $http_status_code\\n      echo \\\"上传应用服务版本失败\\\"\\n      exit 1\\n      fi\"],\r\n	\"stage\": \"version\"\r\n}', NULL, '2022-07-01 10:40:13', NULL, '2022-07-01 10:40:17', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('g6b5010845ee41d4863931c9e71237g5', 'f6b5010845ee41d4863931c9e71237fg', '镜像制作', 'docker', 2, '{\r\n	\"image\": \"gitlabcis/docker:19.03.13\",\r\n	\"script\": [\"docker login -u ${REPOSITORY_USERNAME} -p ${REPOSITORY_PASSWORD} ${REPOSITORY_URL}\", \"docker build -t  ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION} .\", \"docker push ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\"],\r\n	\"stage\": \"docker\"\r\n}', 'admin', '2022-11-11 10:07:11', 'admin', '2022-11-11 10:07:18', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('g6b5010845ee41d4863931c9e71237g6', 'f6b5010845ee41d4863931c9e71237fg', '代码打包', 'build', 1, '{\r\n	\"artifacts\": {\r\n		\"paths\": [\"build/libs/app.jar\"]\r\n	},\r\n	\"image\": \"swr.cn-north-4.myhuaweicloud.com/wutong/gradle-ci:jdk17\",\r\n	\"script\": [\"GRADLE_USER_HOME=\'$(pwd)/.gradle\'\", \"export GRADLE_USER_HOME\", \"chmod 755 ./gradlew \", \"./gradlew build --build-cache -x test \"],\r\n	\"stage\": \"build\"\r\n}', 'admin', '2022-11-11 09:54:55', 'admin', '2022-11-11 09:55:00', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('t6b5010845ee41d4863931c9e71237g5', 'f6b5010845ee41d4863931c9e71237fi', '代码打包', 'build', 1, '{\r\n	\"image\": \"golang:latest\",\r\n	\"stage\": \"build\",\r\n	\"script\": [\"mkdir -p .go\", \"go env -w GO111MODULE=on\", \"go env -w GOPROXY=\\\"https://goproxy.io,direct\\\"\", \"CGO_ENABLED=0 GOOS=linux go build -o app  main.go\"],\r\n	\"artifacts\": {\r\n		\"paths\": [\"app\"]\r\n	},\r\n	\"cache\": {\r\n		\"paths\": [\".go/pkg/mod/\"]\r\n	}\r\n}', 'admin', '2022-12-14 14:37:50', 'admin', '2022-12-12 14:37:55', NULL, NULL);
INSERT INTO `devops_plugins_test`.`devops_custom_pipeline_temp_stage` (`id`, `template_id`, `name`, `code`, `stage_order`, `stage`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `version`) VALUES ('t6b5010845ee41d4863931c9e71237g6', 'f6b5010845ee41d4863931c9e71237fi', '镜像制作', 'docker', 2, '{\r\n	\"image\": \"gitlabcis/docker:19.03.13\",\r\n	\"script\": [\"docker login -u ${REPOSITORY_USERNAME} -p ${REPOSITORY_PASSWORD} ${REPOSITORY_URL}\", \"docker build -t  ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION} .\", \"docker push ${REPOSITORY_URL}/${ORG}/${MODULE}:${DEVOPS_VERSION}\"],\r\n	\"stage\": \"docker\"\r\n}', 'admin', '2022-12-13 14:33:19', 'admin', '2022-12-13 14:33:24', NULL, NULL);
